...
class EmitterOutput:
    ...
    # This dictionary maps the method name to the corresponding dict which
    # contains the mapping of the instruction ids to the number of outputs
...
def emit_program(
    ...
    for name, exported_program in sorted(methods.items()):
        ...
        instruction_id_to_num_outs_map[name] = emitter.instruction_id_to_num_outs_map
    ...
    return EmitterOutput(
        ...
        instruction_id_to_num_outs_map=instruction_id_to_num_outs_map,
        program=Program(
